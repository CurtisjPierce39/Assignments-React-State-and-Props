        ...
        return (
            <section>
                ...
                <div>
                    ...
                    <ul>
                        {movies.map((movie) => (
                            <li key={movie.id}><strong> {movie.title} </strong></li>
                        )  )}
                        {movies.map((movie) => (
                            <li key={movie.id}>{movie.summary}</li>
                        )  )}
                    </ul>
                </div>
                )}
